 ...
 */
public class FeuExecutor extends FeuExecutorBase {

    public static final List<String> ALIASES = Collections.singletonList("feu");
    ...
    public static void listSubCommands(CommandSource src, Map<List<String>, CommandSpec> subCommands, String parentCmd) {
        ...
        int i = 0;
        String prefix = "/feu " + ((!parentCmd.equals("")) ? parentCmd + " " : "");
